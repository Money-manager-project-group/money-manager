  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/table/crud" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">+ 추가</Link>
      </div>
      ...
      {transactions.length === 0 ? (
        ...
        <ul className="space-y-4">
          {transactions.map((t, index)=>(
            <li key={index} className="flex justify-between p-4 border rounded shadow-sm hover:shadow-md"
